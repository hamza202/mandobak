							...
							<div class="m-login__wrapper">
								...
								<div class="m-login__forget-password">
									...
									<form class="m-login__form m-form" action="">
										...
										<div class="m-login__form-action">
											<button id="m_login_forget_password_submit" class="btn btn-theme m-btn m-btn--pill m-btn--custom m-btn--air">Request</button>
											<button id="m_login_forget_password_cancel" class="btn btn-outline-theme  m-btn m-btn--pill m-btn--custom">Cancel</button>
										</div>
									</form>
								</div>
							</div>
